...
// about to make a book image. first part of a type name is an existing time, its a good idea to extend that type
...
struct Image: View {
    ...
    var body: some View {
        ...
        //symbol names we need all require lowercase letters
        //compiler knows that types have to match on either side of the operator. Just write .init instead
